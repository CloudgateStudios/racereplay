...
```bash
# Fetch splits and start times from RTRT.me
...
See [scripts/README.md](scripts/README.md) for full details including flags, timing estimates, and verified results.
